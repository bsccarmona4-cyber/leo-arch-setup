// Busca la página "final unidad 1" en Notion
...
const res = await notion('POST', '/search', { query: 'final unidad', filter: { value: 'page', property: 'object' } });
console.log('RESULTADOS:', res.results.length);
