...
# --- 1. CONFIGURANDO PARÁMETROS DE CONEXIÓN ---
# En Linux, PostgreSQL usa autenticación "peer" por defecto,
# lo que significa que se conecta automáticamente con tu usuario
# del sistema sin necesitar contraseña.
print("--- 1. CONFIGURANDO PARÁMETROS DE CONEXIÓN ---")
nombre_db = "leo"       # nombre de la base de datos
usuario_db = "leo"      # tu usuario de PostgreSQL
